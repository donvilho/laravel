...
SQLEND;
    ...
    $pendingsumscorelist = $sqlresult->fetchAll((\PDO::FETCH_OBJ)); // Muista TÄMÄ FETCH_OBJ
        ...
        return view('studentronic/allscorelist')->with('allscorelist', $allscorelist)->with('sumscorelist', $sumscorelist)->with('totalsumscorelist', $totalsumscorelist)->with('pendingsumscorelist', $pendingsumscorelist);
