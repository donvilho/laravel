...
class CsvController extends Controller
{
    ...
    public function create() {
        return view('studentronic/upload');
    }
...
// CSV-tiedoston lataaminen palvelimelle, lukeminen/muototarkistus ja tallentaminen tietokantaan
 public function store(Request $request) {
    ...
    if($jokuvirhe) {
        ...
        return Redirect::to('studentronic/upload');
    }
    ...
    DB::commit();
    fclose($file);
    return redirect('studentronic/upload')->with('info_msg', 'CSV-tiedoston KAIKKI rivit lisätty onnistuneesti');
}
